...
async function getSpecificBreed() {
    try {
        ...
        let response = await fetch(`https://dog.ceo/api/breed/${selectedBreed}/images/random`);
...
document.getElementById("load-breed-btn").addEventListener("click", getSpecificBreed);
